module PyPlotTools
    ...
    using StartUpDG: map_face_nodes, vandermonde, find_face_nodes, Tri, Quad

    using ..IO: Plotter, new_path
    ...
    """
    Plot 2D numerical solution or parametrized function
    """
    function visualize(
        sol::Union{Array{Float64,3},AbstractParametrizedFunction{2}},
    ...
    """
    Visualize a 2D reference element
    """
