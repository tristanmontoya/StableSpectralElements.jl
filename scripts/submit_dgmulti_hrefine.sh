...
julia --project=.. --threads 4 advection_2d.jl -b 0.005 -m 0.2 -p 4 -r 4 -l 0.0 -M 2 -g 8 -s $scheme -f $form &
julia --project=.. --threads 4 advection_2d.jl -b 0.005 -m 0.2 -p 4 -r 4 -l 1.0 -M 2 -g 8 -s $scheme -f $form &
