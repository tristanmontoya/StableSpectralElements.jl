...
StableSpectralElements.jl is a registered Julia package (compatible with Julia versions 1.8 and 1.9) and can be installed by entering the following commands within the REPL:
```julia
